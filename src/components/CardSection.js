...
const App = () => {
  ...
  return (
    <div className="lol" style={{ backgroundColor: "#0F0F10" }}>
      ...
      >
        Get your own non-custodial card powered by Visa to spend globally and to
      ...
      >
        ...
        community,infrastructure and more while we are backed by some reputable
      ...
      <div
        class="slider2"
        style={{ paddingBottom: "3%", background: "rgb(18, 19, 20)" }}
      >
        <div class="slide-track">
          <div class="slide">
            <img
